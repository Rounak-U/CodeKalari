...
export default function SplineIframe() {
  ...
  return (
    <div style={{ width: "100%", height: "100vh", position: "relative", backgroundColor: "#000000ff" }}>
      ...
      {/* MLH Trust Badge */}
      <a style={{ display: 'block', maxWidth: '800px', height: '1000px', minWidth: '120px', position: 'relative', top: '0', width: '12%', zIndex: 10000 }} href="https://www.iiitkottayam.ac.in/?ref=cybrhome#!/home" target="_blank" rel="noreferrer">
      ...
      >
        <div style={{ pointerEvents: 'auto', display: 'block', marginLeft: '2%' }}>
          ...
          <img src={typeof Apply === 'string' ? Apply : Apply.src || Apply.default || Apply} alt="Apply" style={{borderRadius: '8px', height: '40px'}} />
          </a>
        </div>
      </div>
